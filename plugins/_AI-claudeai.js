...
${usedPrefix + command} jelaskan gambar ini
        ...
        const session = user.claudeSession
        ...
        const systemMessage = {
            ...
            role: 'system',
            content:
                'Ikuti bahasa user dan jawab natural, singkat, jelas, dan tidak kaku. Jika ada gambar, analisis dengan detail.'
        }
        ...
        // =========================
        if (!answer.trim()) {
            answer = 'Tidak ada respon dari Claude.'
        }
