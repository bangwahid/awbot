            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.reply(m.chat, `Limit anda habis*\n\nSilahkan Klaim _.freelimit_ atau Upgrade Status User dengan Menghubungi Owner *${usedPrefix}owner*`, m)
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'Fitur ini hanya dapat digunakan oleh *_OWNER_*',
        owner: 'Fitur ini hanya dapat digunakan oleh *_OWNER_*',
        mods: 'Fitur ini hanya dapat digunakan oleh *_Moderator_*',
        rpg: "Fitur RPG Nonaktif\n\n> Ketik *.enable rpg* agar dapat akses fitur rpg",
        nsfw: "Fitur NSFW Nonaktif\n\n> ketik *.enable nsfw* agar dapat akses fitur NSFW",
        premium: 'Fitur ini hanya dapat digunakan oleh User *_Premium_*',
        group: 'Fitur ini hanya dapat digunakan di *_Group_*',
        private: 'Fitur ini hanya dapat digunakan di *_Chat Pribadi_*',
        admin: 'Fitur ini hanya dapat digunakan oleh *_Admin Group_*',
        botAdmin: 'Jadikan Bot sebagai *_Admin_* untuk menggunakan Fitur ini',
        unreg: 'Silahkan Daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*.daftar nama.umur*\n\nContoh: *#daftar AW Bot.17*',
        restrict: 'Fitur ini di *Nonaktif*'
    }[type]
